...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/websiteController/deleteContact?id="+id;
        else
            return false;
    }
</script>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافه نمودن معلومات</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/websiteController/checkAddContact">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-6 has-success">
                            <input  type="text" name="phone" class="form-control" id="form_control_1" placeholder="شماره تماس"  required>
                            <label for="form_control_1">شماره تماس</label>
                        </div>

                        <div class="form-group form-md-line-input col-md-6 has-success">
                            <input  type="text" name="email" class="form-control" id="form_control_1" placeholder="ایمیل"  required>
                            <label for="form_control_1">ایمیل</label>
                        </div>

                         <div class="form-group form-md-line-input col-md-9 has-success">
                            <textarea  type="text" name="address" class="form-control" id="form_control_1" placeholder="آدرس"  required></textarea>
...
<div class="modal fade" id="editmodal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" align="right" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title">ویرایش معلومات</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/websiteController/checkEditContact">
                      <div class="form-group">
                        <input type="hidden" name="id" id="id">
                        <div class="form-group form-md-line-input col-md-6 has-success">
                            <input  type="text" name="phone" id="phone" class="form-control" id="form_control_1" placeholder="شماره"  required>
                            <label for="form_control_1">شماره</label>
                        </div>

                        <div class="form-group form-md-line-input col-md-6 has-success">
                            <input  type="text" name="email" id="email" class="form-control" id="form_control_1" placeholder="ایمیل"  required>
                            <label for="form_control_1">ایمیل</label>
                        </div>
                         ...
                         <div class="form-group form-md-line-input col-md-9 has-success">
                            <textarea  type="text" name="address" id="address" class="form-control" id="form_control_1" placeholder="آدرس"  required></textarea>
                            <label for="form_control_1">آدرس</label>
                        </div>
                        <br><br>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url()?>index.php/websiteController/index" class="btn btn-circle green-meadow">بستن</a>
                    </div>
                </div>
            </div>
        </div>
