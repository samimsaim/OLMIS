                                            ...
                                            <label class="col-md-3 control-label" style="font-weight: bold;">ملاحظات*</label>
                                                ...
                                                <div class="row">
                                                 <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_waredaNumber)) echo 'has-error' ?>">
                                                     ...
                                                     <div class="col-md-9">
                                                           <input type="text" class="form-control" name="waredaNumber" value="<?php if (!empty($Field_data['valuemNumber'])) echo $Field_data['valuemNumber']; ?>" placeholder="">
                                                         <div class="form-control-focus"> </div>
                                                   ...
                                                   <div class="row">
                                                    <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_qaidWareda)) echo 'has-error' ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                              <input type="text" class="form-control" name="qaidWareda" value="<?php if (!empty($Field_data['valuemNumber'])) echo $Field_data['valuemNumber']; ?>" placeholder="">
                                                            <div class="form-control-focus"> </div>
