...
<script src="<?=base_url()?>assets/global/plugins/jquery.min.js" type="text/javascript"></script>
                <!-- BEGIN CONTENT -->
  <!-- .................................................... -->
<script src="<?=base_url()?>assets/asset/global/plugins/jquery.min.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/asset/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/asset/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?=base_url()?>assets/asset/global/plugins/select2/select2.min.js"></script>
<script src="<?=base_url()?>assets/asset/global/scripts/metronic.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/asset/admin/layout/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="<?=base_url()?>assets/asset/admin/pages/scripts/components-dropdowns.js"></script>
<script>
