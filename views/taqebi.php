                            ...
                            <tbody>
                                <?php foreach ($data as $row) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php $this->db->where('ID',$value->ID_nawyat_maktob);
                                              $this->db->from('nawyat_maktob');
                                              $dat=$this->db->get()->result();
                                              foreach($dat as $NM){
                                         ?>
                                        <td style="text-align: center;"><?=$NM->nawyat?></td>
                                    <?php }?>
                                        <td style="text-align: center;"><?=$value->khulas_matlab?></td>
                                        <td style="text-align: center;"><?=$value->date?></td>

                                        <td style="text-align: center;">
                                         <a href="<?=base_url()?>index.php/taqebiController/taqebiDetail?id=<?=$row->ID?>" class="btn btn-circle btn-icon-only  green-jungle"><span class="glyphicon glyphicon-eye-open "></a>
                                        <a class="btn btn-circle btn-icon-only btn-success" href="<?=base_url()?>index.php/makatebController/editMakateb?id=<?=$row->ID?>"><span class="fa fa-pencil"></a>
