                                ...
                                <?php foreach ($data as $row) { ?>
                                    ...
                                    <?php }?>
                                        ...
                                        <td style="text-align: center;">
                                         <a href="<?=base_url()?>index.php/wardaController/wardaDetail?id=<?=$row->ID?>" class="btn btn-circle btn-icon-only  green-jungle"><span class="glyphicon glyphicon-eye-open "></a>
