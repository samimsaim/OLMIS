    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?=base_url()?>index.php/UsersController/index">کاربران</a>
                    <i class="fa fa-angle-left"></i>
                </li>
                <li>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle green-meadow" href="<?=base_url()?>index.php/UsersController/index" style="font-size: 16px;">
                        ...
                        <div class="form-group form-md-line-input <?php if (!empty($error_privilege)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="privilege">
                                    ...
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'guest') echo ' selected '?> value="4">ریس</option>
                                <?php }?>
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'admin') echo ' selected '?> value="1">مدیر عمومی</option>
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'guest') echo ' selected '?> value="2">مدیر عرایض</option>
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'guest') echo ' selected '?> value="3">مدیر  تعقیبی</option>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                ...
                                <input type="submit" name="addUser" class="btn btn-circle green-meadow" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
