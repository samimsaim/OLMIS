                                    ...
                                    <table class="table table-striped table-bordered table-hover order-column" id="">
                                        ...
                                        <tbody style="text-align: center;">
                                            ...
                                            <tr>
                                                ...
                                                $data=$this->db->query("SELECT sadra_number FROM makateb WHERE mursal_elai='$row->mursal_elai' AND sadra_number!=' 'AND sadra_number!='0'  AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                ...
                                                $data=$this->db->query("SELECT warda_number FROM makateb WHERE mursal_elai='$row->mursal_elai' AND warda_number!=' 'AND warda_number!='0'  AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                <td><?=$query?></td>
                                                <?php 
                                                ...
                                                $data=$this->db->query("SELECT ID_category FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_category!=' 'AND ID_category!='0' AND ID_category='2' AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                <td><?=$query?></td>
                                                 <?php 
                                                ...
                                                $data=$this->db->query("SELECT ID_ejraat_result FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_ejraat_result!=' 'AND ID_ejraat_result!='0' AND ID_ejraat_result='1' AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                <td><?=$query?></td>
                                                 <?php 
                                                ...
                                                $data=$this->db->query("SELECT ID_ejraat_result FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_ejraat_result!=' 'AND ID_ejraat_result!='0' AND ID_ejraat_result='2' AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                <td><?=$query?></td>
                                                <?php 
                                                ...
                                                $data=$this->db->query("SELECT ID_ejraat_result FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_ejraat_result!=' 'AND ID_ejraat_result!='0' AND ID_ejraat_result='3' AND '$year1'='$year' AND '$mount1'='05'");
                                                $query=$data->num_rows();
                                                        ?>
                                                <td><?=$query?></td>
                                                 <?php 
                                                ...
                                                $data1=$this->db->query("SELECT sadra_number FROM makateb WHERE mursal_elai='$row->mursal_elai' AND sadra_number!=' 'AND sadra_number!='0'  AND '$year1'='$year' AND '$mount1'='05'");
                                               ...
                                               $date3 = DateTime::createFromFormat("Y-m-d", $row->date);
                                                ...
                                                $data2=$this->db->query("SELECT warda_number FROM makateb WHERE mursal_elai='$row->mursal_elai' AND warda_number!=' 'AND warda_number!='0'  AND '$year3'='$year2' AND '$mount3'='05'");
                                               ...
                                               $date3 = DateTime::createFromFormat("Y-m-d", $row->date);
                                                ...
                                                $data2=$this->db->query("SELECT warda_number FROM makateb WHERE mursal_elai='$row->mursal_elai' AND warda_number!=' 'AND warda_number!='0'  AND '$year1'='$year' AND '$mount3'='05'");
                                                $query2=$data2->num_rows();
                                                if($query2!=0){
                                                ...
                                                $data1=$this->db->query("SELECT ID_category FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_category!=' 'AND ID_category!='0' AND ID_category='1' AND '$year1'='$year' AND '$mount1'='05'");
                                                $query1=$data1->num_rows();
                                                /////////////////////////////////////////////////////////
                                                ...
                                                $data2=$this->db->query("SELECT ID_category FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_category!=' 'AND ID_category!='0' AND ID_category='2' AND '$year2'='$year1' AND '$mount2'='05'");
                                                $query2=$data2->num_rows();
                                                ///////////////////////////////////////////////////////////
                                                ...
                                                $data3=$this->db->query("SELECT ID_category FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_category!=' 'AND ID_category!='0' AND ID_category='3' AND '$year3'='$year2' AND '$mount3'='05'");
                                                ...
                                                $data4=$this->db->query("SELECT ID_category FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_category!=' 'AND ID_category!='0' AND ID_category='4' AND '$year4'='$year3' AND '$mount4'='05'");
                                                ...
                                                $data2=$this->db->query("SELECT ID_ejraat_result FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_ejraat_result!=' 'AND ID_ejraat_result!='0' AND ID_ejraat_result='2' AND '$year2'='$year1' AND '$mount2'='05'");
                                                $query2=$data2->num_rows();
                                                ///////////////////////////////////////////////////////////
                                                ...
                                                $data3=$this->db->query("SELECT ID_ejraat_result FROM makateb WHERE mursal_elai='$row->mursal_elai' AND ID_ejraat_result!=' 'AND ID_ejraat_result!='0' AND ID_ejraat_result='3' AND '$year3'='$year2' AND '$mount3'='05'");
                                                $query3=$data3->num_rows();
                                               if($query1!=0){
