                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6" style=" margin-bottom: -8px;">
                                <div class="btn-group">
                                    <a href="<?php echo base_url()?>index.php/ahkamController/addHukom"  class="btn btn-circle green-meadow">اضافه نمودن<i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                            <div class="col-md-6">
     ...
     <script>
        $(document).ready(function(){
            var DataTable = $('#cars_data').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"<?=base_url()?>index.php/ahkamController/fetchAllAhkam",
                    type:"POST"
