        ...
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="makateb_data" style="text-align: center;">
                            <thead>
                                <tr>
   ...
   <?php } ?>
     <script>
        $(document).ready(function(){
            var DataTable = $('#makateb_data').DataTable({
                "processing": true,
                "serverSide": true,
                "order":[],
                "ajax":{
