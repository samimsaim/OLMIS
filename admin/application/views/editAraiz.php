...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
                ...
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/araizController/checkEditAraiz" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_shomaraiAreza)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="shomaraiAreza" value="<?=$ara->shumara_ariza ?>" placeholder="">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="usage" style="text-align: right;" class="form-control" name="date" value="<?=$ara->date?>" placeholder="۱۳۹۸/۳/۲">
                                <div class="form-control-focus"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mursal)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="mursal" value="<?=$ara->mursal?>" placeholder="">
                                <div class="form-control-focus"> </div>
      ...
      <label class="col-md-3 control-label" style="font-weight: bold;">مرسل الیه*</label>
       <div class="col-md-9">
      <input type="text" class="form-control" name="mursalAlai" value="<?=$ara->mursal_elai?>" placeholder="">
        <div class="form-control-focus"></div>
                    ...
                    <?php }?>
                        ...
                        <div class="row">
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_saderaNumber)) echo 'has-error' ?>">
                             ...
                             <div class="col-md-9">
                                <input type="text" class="form-control" name="saderaNumber" value="<?=$ara->sadra_number?>" placeholder="">
                                 <div class="form-control-focus"> </div>
          ...
          <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dosyaArchive)) echo 'has-error' ?>">
                    ...
                    <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_khulasMatlab)) echo 'has-error' ?>">
                       <label class="col-md-3 control-label" style="font-weight: bold;">خلص مطلب*</label>
                            <div class="col-md-9">
                                 <input type="text" class="form-control" name="khulasMatlab" value="<?=$ara->khulas_matlab?>" placeholder="">
                                    <div class="form-control-focus"></div>
                         ...
                         <div class="col-md-9">
                              <input type="text" class="form-control" name="bakhsheTahrerat" value="<?=$ara->tahrerat?>" placeholder="">
                                   <div class="form-control-focus"> </div>
                                  ...
                                  <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mulahezat)) echo 'has-error' ?>">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" class="form-control" name="mulahezat" value="<?=$ara->mulahezat?>" placeholder="">
                                      <div class="form-control-focus"></div>
                                 ...
                                 <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_photo)) echo 'has-error' ?>">
                                      ...
                                      <div class="col-md-9">
                                          <input type="file" class="form-control" name="photo" value="<?php if (!empty($Field_data['photo'])) echo $Field_data['photo']; ?>" placeholder="۵۰۰">
                                          <div class="form-control-focus"> </div>
                                  ...
                                  <input type="hidden" name="id" value="<?=$ara->shumara_ariza?>">
                                  </div>
