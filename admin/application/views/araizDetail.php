             ...
             <?php foreach ($makateb as $MaktobNu) {} ?>
                <div class="portlet-body">
                    ...
                    <div class="col-md-3">
                      ...
                      <?php $this->db->where('shumara_ariza',$row->shumara_ariza);
                              $this->db->from('araiz');
                        ...
                        <a  style="margin-right: 50px;" href="<?=base_url()?>index.php/araizController/download?id=<?=$dat->image?>"> <span class="btn btn-success">downlaod</span></a>
                    </div>
                <?php } ?>
                  </div>
                </div>
